...
// }}}
// {{{ CLI.util.DelayedTask

describe("CLI.util.DelayedTask", function() {
    ...
    it('should delay the call', function() {
        ...
        d = new CLI.util.DelayedTask(function() {
            called = true;
        });
        d.delay(100);
  ...
  /*
    ...
    it('should cancel any previous invocations', function() {
        ...
        d = new CLI.util.DelayedTask(incr);
  ...
  /*
    ...
    it('should not cancel any previous invocations', function() {
        ...
        d = new CLI.util.DelayedTask(incr, null, null, false);
  ...
  /*
    it("should accept a delay of 0", function() {
        var called = true;
        var d = new CLI.util.DelayedTask(function() {
            called = true;    
        });
        d.delay(1000);
        d.delay(0);
