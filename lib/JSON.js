...
(function() {
    ...
    CLI.JSON = (new(function() {
        ...
        var me = this,
        hasNative = global.JSON && JSON.toString() == '[object JSON]',
        ...
        doEncode = function(o, newline) {
            ...
            if (o === null || o === undefined) {
                return "null";
            } else if (CLI.isDate(o)) {
                return me.encodeDate(o);
            } else if (CLI.isString(o)) {
                if (CLI.isMSDate(o)) {
            ...
            // Date/String have a toJSON in some environments, so check these first.
                ...
                return o.toJSON();
            } else if (CLI.isArray(o)) {
                return encodeArray(o, newline);
            } else if (CLI.isObject(o)) {
         ...
         * To override this:
         *
         *     CLI.JSON.encodeString = function(s) {
         *         return 'Foo' + s;
         *     };
         *
         ...
         * when {@link CLI#USE_NATIVE_JSON} is `false`.
         * 
         ...
         * To override this:
         *
         *     CLI.JSON.encodeDate = function(d) {
         *         return CLI.Date.format(d, '"Y-m-d"');
         *     };
         *
         ...
         * 
         * If the environment's native JSON encoding is not being used ({@link CLI#USE_NATIVE_JSON} is not set,
         * or the environment does not support it), then CLI Framework's encoding will be used. This allows the developer
        ...
        me.encode = function(o) {
            ...
            if (hasNative && CLI.USE_NATIVE_JSON) {
