...
(function() {
    ...
    CLI.define('CLI.Template', {
        ...
        inheritableStatics: {
             ...
             * @return {CLI.Template} The created template
             * @static
             * @inheritable
             */
        ...
        compile: function() {
            ...
            code = (this.disableFormats !== true ? 'var fm=CLI.util.Format;' : '') +
                (me.useEval ? '$=' : 'return') +
                " function(v){return ['" + code + "'];};";

            me.fn  = me.useEval ? me.evalCompiled(code) : (new Function('CLI', code))(CLI);
            me.compiled = true;
            return me;
        },
         ...
         *
         * @param {String/HTMLElement/CLI.dom.Element} el The context element
         * @param {Object/Array} values The template values. See {@link #applyTemplate} for details.
         * @param {Boolean} returnElement (optional) true to return a CLI.Element.
         * @return {HTMLElement/CLI.dom.Element} The new node or Element
         */
         ...
         *
         * For example usage see {@link CLI.Template CLI.Template class docs}.
         *
         * @param {String/HTMLElement/CLI.dom.Element} el The context element
         * @param {Object/Array} values The template values. See {@link #applyTemplate} for details.
         * @param {Boolean} returnElement (optional) true to return an CLI.Element.
         * @return {HTMLElement/CLI.dom.Element} The new node or Element
         */
        ...
        doInsert: function(where, el, values, returnElement) {
            var newNode = CLI.DomHelper.insertHtml(where, CLI.getDom(el), this.apply(values));
            return returnElement ? CLI.get(newNode) : newNode;
        },
        ...
        overwrite: function(el, values, returnElement) {
            var newNode = CLI.DomHelper.overwrite(CLI.getDom(el), this.apply(values));
            return returnElement ? CLI.get(newNode) : newNode;
        }
    }, function(Template){
