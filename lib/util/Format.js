            ...
            if (!CLI.isDate(value)) {
                ...
                if (isNaN(date)) {
                    ...
                    if (this.iso8601TestRe.test(value)) {
                        ...
                        if (CLI.os.is.Android && CLI.os.version.isLessThan("3.0")) {
                ...
                if (isNaN(date)) {
                    ...
                    //<debug>
                    if (isNaN(date)) {
                        CLI.Logger.error("Cannot parse the passed value " + value + " into a valid date");
                    }
                    //</debug>
                }
                value = date;
            }
            return CLI.Date.format(value, format || CLI.util.Format.defaultDateFormat);
        },
        */
