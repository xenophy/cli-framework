...
CLI.define('CLI.app.Application', {
    ...
    onBeforeLaunch: function() {
        ...
        try {
            ...
            if (argv.length >= 1 && main === 'help') {

                var tmp = CLI.Array.clone(argv);
            ...
            mainCls.argv = require('optimist').argv;
            ...
            try {
                ...
                main = 'help';
                mainClsName = CLI.String.format('{0}.controller.{1}', me.getName(), CLI.String.capitalize(main));
                mainCls = CLI.create(mainClsName);
