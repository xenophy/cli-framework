    ...
    CLI.Function = (function() {
        ...
        fireHandlers = function() {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (animFrameMap[id]) {
                    handler[0].apply(handler[1] || CLI.global, handler[2] || animFrameNoArgs);
        ...
        fireElevatedHandlers = function() {
            CLI.elevateFunction(fireHandlers);
        },
        CLIFunction = {
            /**
                ...
                return function(name, value) {
                    ...
                    if (name !== null) {
                        if (typeof name !== 'string') {
                            ...
                            if (CLI.enumerables) {
                                for (i = CLI.enumerables.length; i--;) {
                                    k = CLI.enumerables[i];
                                    if (name.hasOwnProperty(k)) {
                                        setter.call(this, k, name[k]);
                                    }
            ...
            /**
             * Captures the given parameters for a later call to `CLI.callback`. This binding is
             * most useful for resolving scopes for example to an `CLI.app.ViewController`.
             *
            ...
            createInterceptor: function(origFn, newFn, scope, returnValue) {
                if (!CLI.isFunction(newFn)) {
                    ...
                    return function() {
                        ...
                        newFn.target = me;
                        newFn.method = origFn;
                        return (newFn.apply(scope || me || CLI.global, args) !== false) ? 
                            origFn.apply(me || CLI.global, args) : returnValue;
                    };
                }
            },
            ...
            createDelayed: function(fn, delay, scope, args, appendArgs) {
                ...
                return function() {
                    ...
                    setTimeout(function() {
                        if (CLI.elevateFunction) {
                            CLI.elevateFunction(fn, me, args);
                        } else {
                            fn.apply(me, args);
                        }
                    }, delay);
            ...
            createBuffered: function(fn, buffer, scope, args) {
                ...
                return function() {
                    ...
                    timerId = setTimeout(function(){
                        if (CLI.elevateFunction) {
                            CLI.elevateFunction(fn, me, callArgs);
                        } else {
            ...
            createAnimationFrame: function(fn, scope, args, queueStrategy) {
                ...
                return function() {
                    ...
                    if (queueStrategy === 3 && timerId) {
                        CLIFunction.cancelAnimationFrame(timerId);
                    }

                    if ((queueStrategy & 1) || !timerId) {
                        timerId = CLIFunction.requestAnimationFrame(function() {
                            timerId = null;
            ...
            requestAnimationFrame: function(fn, scope, args) {
                ...
                if (!animFrameId) {
                    animFrameId = requestAnimFrame(CLI.elevateFunction ? fireElevatedHandlers : fireHandlers);
                }
                return id;
            },
            ...
            createThrottled: function(fn, interval, scope) {
                ...
                execute = function() {
                    if (CLI.elevateFunction) {
                        CLI.elevateFunction(fn, scope, lastArgs);
                    } else {
        ...
        CLI.deferCallback = CLIFunction.requestAnimationFrame;
