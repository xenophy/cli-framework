        ...
        CLIArray = {
            ...
            map: ('map' in arrayPrototype) ? function(array, fn, scope) {
                ...
                CLI.Assert.isFunction(fn, 
                                      'CLI.Array.map must have a callback function passed as second argument.');
                                      //</debug>
            ...
            every: ('every' in arrayPrototype) ? function(array, fn, scope) {
                //<debug>
                CLI.Assert.isFunction(fn, 
                                      'CLI.Array.every must have a callback function passed as second argument.');
                                      //</debug>
            ...
            some: ('some' in arrayPrototype) ? function(array, fn, scope) {
                //<debug>
                CLI.Assert.isFunction(fn, 
                                      'CLI.Array.some must have a callback function passed as second argument.');
                                      //</debug>
            ...
            filter: ('filter' in arrayPrototype) ? function(array, fn, scope) {
                //<debug>
                CLI.Assert.isFunction(fn, 
                                      'CLI.Array.filter must have a filter function passed as second argument.');
                                      //</debug>
