...
(function() {
    ...
    CLI.Number = new function() {
        ...
        CLI.apply(CLINumber, {
             ...
             *          var range = CLI.Number.clipIndices(array.length, [begin, end]);
             *
             *          begin = range[0];
             *          end   = range[1];
             *
             ...
             *       -8  -7  -6  -5  -4  -3  -2  -1
             *
             *      console.log(CLI.Number.clipIndices(8, [3, 10]); // logs "[3, 8]"
             *      console.log(CLI.Number.clipIndices(8, [-5]);    // logs "[3, 8]"
             *      console.log(CLI.Number.clipIndices(8, []);
             *      console.log(CLI.Number.clipIndices(8, []);
             *
             * @param {Number} length
             ...
             *
             *     r = CLI.Number.snap(56, 2, 55, 65);        // Returns 56 - snap points are zero based
             *
             *     r = CLI.Number.snapInRange(56, 2, 55, 65); // Returns 57 - snap points are based from minValue
             *
            ...
            snap : function(value, increment, minValue, maxValue) {
                ...
                return CLINumber.constrain(value, minValue,  maxValue);
            ...
            snapInRange : function(value, increment, minValue, maxValue) {
                ...
                if (maxValue !== undefined) {
                    ...
                    if (value > (maxValue = CLINumber.snapInRange(maxValue, increment, minValue))) {
             ...
             * it is not.
             ...
             CLI.Number.from('1.23', 1); // returns 1.23
             CLI.Number.from('abc', 1); // returns 1
