    ...
    CLI.Assert = {
        ...
        falseyProp: function (object, property) {
            ...
            if (b) {
                ...
                CLI.Error.raise('Expected a falsey value for ' + property +
                                ' but was ' + b);
            }
        },
        ...
        truthyProp: function (object, property) {
            ...
            if (!b) {
                ...
                CLI.Error.raise('Expected a truthy value for ' + property +
                                ' but was ' + typeof b);
            }
        }
    };
        ...
        function makeAssertProp (name, kind) {
            ...
            return function (object, prop) {
                ...
                if (!testFn(object[prop])) {
                    CLI.Error.raise(def || (def = 'Expected ' + 
