 ...
 *     console.log(CLI.Date.format(dt, 'Y-m-d'));                          // 2007-01-10
 *     console.log(CLI.Date.format(dt, 'F j, Y, g:i a'));                  // January 10, 2007, 3:05 pm
 *     console.log(CLI.Date.format(dt, 'l, \\t\\he jS \\of F Y h:i:s A')); // Wednesday, the 10th of January 2007 03:05:01 PM
 *
 * Here are some standard date/time patterns that you might find helpful.  They
 * are not part of the source of CLI.Date, but to use them you can simply copy this
 * block of code into any script that is included after CLI.Date and they will also become
 ...
 *
 *     var dt = new Date();
 *     console.log(CLI.Date.format(dt, CLI.Date.patterns.ShortDate));
 *
...
(function() {
    ...
    CLI.Date = (function () {
        ...
        var utilDate,
            ...
            code = [
                // date calculations (note: the code below creates a dependency on CLI.Number.from())
                "var me = this, dt, y, m, d, h, i, s, ms, o, O, z, zz, u, v, W, year, jan4, week1monday, daysInMonth, dayMatched,",
                "def = me.defaults,",
                "from = CLI.Number.from,",
                ...
                //
                // v = CLI.Date.clearTime(new Date(week1monday.getTime() + ((W - 1) * 604800000 + 43200000)));
        ...
        // create private copy of CLI Framework's `CLI.util.Format.format()` method
        ...
        return utilDate = {
            ...
            /** @ignore */
            now: Date.now, // always available due to polyfill in CLI.js
            ...
            formatCodeToRegex: function(character, currentGroup) {
                ...
                // Note: currentGroup - position in regex result array (see notes for CLI.Date.parseCodes below)
                ...
                return p ? CLI.applyIf({
                    c: p.c ? xf(p.c, currentGroup || "{0}") : p.c
                }, p) : {
                    g: 0,
                    c: null,
                    s: CLI.String.escapeRegex(character) // treat unrecognized characters as literals
                };
             ...
             * date formats are requested for CLI standard formatting strings.
             *
             ...
             * Example:
             *
             *     CLI.Date.parseFunctions['x-date-format'] = myDateParser;
             *
             ...
             * Example:
             *
             *     CLI.Date.formatFunctions['x-date-format'] = myDateFormatter;
             *
             ...
             *     CLI.Date.defaults.d = 1;
             *
             *     // parse a February date string containing only year and month values.
             *     // setting the default day value to 1 prevents weird date rollover issues
             *     // when attempting to parse the following date string on, for example, March 31st 2009.
             *     CLI.Date.parse('2009-02', 'Y-m'); // returns a Date object representing February 1st 2009.
             *
             * @property defaults
             * @type Object
             */
             ...
             * The date format string that the {@link CLI.util.Format#dateRenderer}
             * and {@link CLI.util.Format#date} functions use.  See {@link CLI.Date} for details.
             *
            ...
            getShortMonthName : function(month) {
                return CLI.Date.monthNames[month].substring(0, 3);
            },
            ...
            getShortDayName : function(day) {
                return CLI.Date.dayNames[day].substring(0, 3);
            },
            ...
            getMonthNumber : function(name) {
                // handle camel casing for English month names (since the keys for the CLI.Date.monthNumbers hash are case sensitive)
                return CLI.Date.monthNumbers[name.substring(0, 1).toUpperCase() + name.substring(1, 3).toLowerCase()];
            },
             ...
             *
             * __Note:__ `CLI.Date.format()` treats characters as literals if an appropriate mapping cannot be found.
             *
             * Example:
             *
             *     CLI.Date.formatCodes.x = "CLI.util.Format.leftPad(this.getDate(), 2, '0')";
             *     console.log(CLI.Date.format(new Date(), 'X'); // returns the current day of the month
             * @type Object
             */
    formatCodes : {
        d: "CLI.String.leftPad(this.getDate(), 2, '0')",
        D: "CLI.Date.getShortDayName(this.getDay())", // get localized short day name
        j: "this.getDate()",
        l: "CLI.Date.dayNames[this.getDay()]",
        N: "(this.getDay() ? this.getDay() : 7)",
        S: "CLI.Date.getSuffix(this)",
        w: "this.getDay()",
        z: "CLI.Date.getDayOfYear(this)",
        W: "CLI.String.leftPad(CLI.Date.getWeekOfYear(this), 2, '0')",
        F: "CLI.Date.monthNames[this.getMonth()]",
        m: "CLI.String.leftPad(this.getMonth() + 1, 2, '0')",
        M: "CLI.Date.getShortMonthName(this.getMonth())", // get localized short month name
        n: "(this.getMonth() + 1)",
        t: "CLI.Date.getDaysInMonth(this)",
        L: "(CLI.Date.isLeapYear(this) ? 1 : 0)",
        o: "(this.getFullYear() + (CLI.Date.getWeekOfYear(this) == 1 && this.getMonth() > 0 ? +1 : (CLI.Date.getWeekOfYear(this) >= 52 && this.getMonth() < 11 ? -1 : 0)))",
        Y: "CLI.String.leftPad(this.getFullYear(), 4, '0')",
        y: "('' + this.getFullYear()).substring(2, 4)",
        a: "(this.getHours() < 12 ? 'am' : 'pm')",
        A: "(this.getHours() < 12 ? 'AM' : 'PM')",
        g: "((this.getHours() % 12) ? this.getHours() % 12 : 12)",
        G: "this.getHours()",
        h: "CLI.String.leftPad((this.getHours() % 12) ? this.getHours() % 12 : 12, 2, '0')",
        H: "CLI.String.leftPad(this.getHours(), 2, '0')",
        i: "CLI.String.leftPad(this.getMinutes(), 2, '0')",
        s: "CLI.String.leftPad(this.getSeconds(), 2, '0')",
        u: "CLI.String.leftPad(this.getMilliseconds(), 3, '0')",
        O: "CLI.Date.getGMTOffset(this)",
        P: "CLI.Date.getGMTOffset(this, true)",
        T: "CLI.Date.getTimezone(this)",
        ...
        c: function() { // ISO-8601 -- UTC format
            return [
              "this.getUTCFullYear()", "'-'",
              "CLI.util.Format.leftPad(this.getUTCMonth() + 1, 2, '0')", "'-'",
              "CLI.util.Format.leftPad(this.getUTCDate(), 2, '0')",
              "'T'",
              "CLI.util.Format.leftPad(this.getUTCHours(), 2, '0')", "':'",
              "CLI.util.Format.leftPad(this.getUTCMinutes(), 2, '0')", "':'",
              "CLI.util.Format.leftPad(this.getUTCSeconds(), 2, '0')",
              "'Z'"
            ].join(" + ");
        },
        */
        ...
        U: "Math.round(this.getTime() / 1000)"
             ...
             *     dt = CLI.Date.parse("2006", "Y");
             *     
             *     //dt = Sun Jan 15 2006 (all date parts specified)
             *     dt = CLI.Date.parse("2006-01-15", "Y-m-d");
             *     
             *     //dt = Sun Jan 15 2006 15:20:01
             *     dt = CLI.Date.parse("2006-01-15 3:20:01 PM", "Y-m-d g:i:s A");
             *     
             *     // attempt to parse Sun Feb 29 2006 03:20:01 in strict mode
             *     dt = CLI.Date.parse("2006-02-29 03:20:01", "Y-m-d H:i:s", true); // returns null
             *
            ...
            parse : function(input, format, strict) {
                ...
                return p[format].call(utilDate, input, CLI.isDefined(strict) ? strict : utilDate.useStrict);
            },
            ...
            getFormatCode : function(character) {
                ...
                return f || ("'" + CLI.String.escape(character) + "'");
            },
            ...
            createFormat : function(format) {
                ...
                for (i = 0; i < format.length; ++i) {
                    ...
                    if (!special && ch == "\\") {
                        ...
                        special = false;
                        code.push("'" + CLI.String.escape(ch) + "'");
                ...
                utilDate.formatFunctions[format] = CLI.functionFactory("return " + code.join('+'));
            ...
            createParser : function(format) {
                ...
                for (; i < len; ++i) {
                    ...
                    if (!special && ch == "\\") {
                        ...
                        special = false;
                        regex.push(CLI.String.escape(ch));
                ...
                utilDate.parseFunctions[format] = CLI.functionFactory("input", "strict", xf(code, regexNum, calc.join('')));
            ...
            parseCodes : {
                ...
                O: {
                    ...
                    c:[
                        ...
                        "o = ((-12 <= (hr*60 + mn)/60) && ((hr*60 + mn)/60 <= 14))? (sn + CLI.String.leftPad(hr, 2, '0') + CLI.String.leftPad(mn, 2, '0')) : null;\n" // -12hrs <= GMT offset <= 14hrs
                    ].join("\n"),
            ...
            //Old CLI.Date prototype methods.
            // private
             ...
             *     console.log(CLI.Date.getTimezone(dt));
             *
             ...
             *     @example
             *     var dt = new Date('9/17/2011');
             *     console.log(CLI.Date.getGMTOffset(dt));
             *
             * @param {Date} date The date
            ...
            getGMTOffset : function(date, colon) {
                ...
                return (offset > 0 ? "-" : "+")
                       + CLI.String.leftPad(Math.floor(Math.abs(offset) / 60), 2, "0")
                       + (colon ? ":" : "")
                       + CLI.String.leftPad(Math.abs(offset % 60), 2, "0");
            },
             ...
             *     @example
             *     var dt = new Date('9/17/2011');
             *     console.log(CLI.Date.getDayOfYear(dt)); // 259
             *
             * @param {Date} date The date
             ...
             *     @example
             *     var dt = new Date('9/17/2011');
             *     console.log(CLI.Date.getWeekOfYear(dt)); // 37
             *
             * @param {Date} date The date.
             ...
             *     console.log(CLI.Date.isLeapYear(dt)); // false
             *
             * @param {Date} date The date
             ...
             *          firstDay = CLI.Date.getFirstDayOfMonth(dt);
             *      console.log(CLI.Date.dayNames[firstDay]); // output: 'Monday'
             *
             * @param {Date} date The date
             ...
             *
             *     var dt = new Date('1/10/2007'),
             *         lastDay = CLI.Date.getLastDayOfMonth(dt);
             *     console.log(CLI.Date.dayNames[lastDay]); // output: 'Wednesday'
             *
             * @param {Date} date The date
             * @return {Number} The day number (0-6).
             */
            ...
            clearTime : function(date, clone) {
                ...
                if (clone) {
                    return CLI.Date.clearTime(CLI.Date.clone(date));
                }
                ...
                if (date.getDate() != d) { // account for DST (i.e. day of month changed when setting hour = 0)
                    ...
                    for (hr = 1, c = utilDate.add(date, CLI.Date.HOUR, hr); c.getDate() != d; hr++, c = utilDate.add(date, CLI.Date.HOUR, hr));
             ...
             *
             *     // Basic usage:
             *     var dt = CLI.Date.add(new Date('10/29/2006'), CLI.Date.DAY, 5);
             *     console.log(dt); // returns 'Fri Nov 03 2006 00:00:00'
             *
             *     // Negative values will be subtracted:
             *     var dt2 = CLI.Date.add(new Date('10/1/2006'), CLI.Date.DAY, -5);
             *     console.log(dt2); // returns 'Tue Sep 26 2006 00:00:00'
             *
             *      // Decimal values can be used:
             *     var dt3 = CLI.Date.add(new Date('10/1/2006'), CLI.Date.DAY, 1.25);
            ...
            add : function(date, interval, value) {
                ...
                if (value) {
                    ...
                    switch(interval.toLowerCase()) {
                        ...
                        case CLI.Date.SECOND:
                            d.setTime(d.getTime() + value * 1000);
                        break;

                        case CLI.Date.MINUTE:
                        ...
                        case CLI.Date.MONTH:
                            ...
                            if (day > 28) {
                                day = Math.min(day, CLI.Date.getLastDateOfMonth(CLI.Date.add(CLI.Date.getFirstDateOfMonth(date), CLI.Date.MONTH, value)).getDate());
                            }
                        ...
                        case CLI.Date.YEAR:
                            day = date.getDate();
                            if (day > 28) {
                                day = Math.min(day, CLI.Date.getLastDateOfMonth(CLI.Date.add(CLI.Date.getFirstDateOfMonth(date), CLI.Date.YEAR, value)).getDate());
                            }
                            d.setDate(day);
                ...
                if (decimalValue) {
                    ...
                    switch (interval.toLowerCase()) {
                        case CLI.Date.MILLI:    base = 1;               break;
                        case CLI.Date.SECOND:   base = 1000;            break;
                        case CLI.Date.MINUTE:   base = 1000*60;         break;
                        case CLI.Date.HOUR:     base = 1000*60*60;      break;
                        case CLI.Date.DAY:      base = 1000*60*60*24;   break;
                        case CLI.Date.MONTH:
             ...
             *
             *     // Basic usage:
             *     var dt = CLI.Date.subtract(new Date('10/29/2006'), CLI.Date.DAY, 5);
             *     console.log(dt); // returns 'Tue Oct 24 2006 00:00:00'
             *
             *     // Negative values will be added:
             *     var dt2 = CLI.Date.subtract(new Date('10/1/2006'), CLI.Date.DAY, -5);
             *     console.log(dt2); // returns 'Fri Oct 6 2006 00:00:00'
             *
             *      // Decimal values can be used:
             *     var dt3 = CLI.Date.subtract(new Date('10/1/2006'), CLI.Date.DAY, 1.25);
            ...
            diff: function (min, max, unit) {
                ...
                var CLIDate = CLI.Date, est, diff = +max - min;
                ...
                switch (unit) {
                    ...
                    case CLIDate.MONTH:
                        ...
                        if (CLI.Date.add(min, unit, est) > max) {
                            return est - 1;
                        } else {
                            return est;
                        }
