 ...
 * via the {@link Ext#require} shorthand. CLI.Loader supports both asynchronous and synchronous loading
...
// @require CLI.Base
// @require CLI.Class
// @require CLI.ClassManager
// @require CLI.Function
// @require CLI.Array
// @require CLI.env.Ready
...
//        Ready = CLI.env.Ready,
    ...
    CLI.apply(Loader, {
        ...
        /**
         * fixes up loader path configs by prepending CLI.Boot#baseUrl to the beginning
...
// TODO: this timing of this needs to be deferred until all classes have had a chance to be created
         ...
         * {@link Ext#require CLI.require} calls.
         *
