...
CLI.define('CLI.mixin.Observable', {
    ...
    enableBubble: function(events) {
        ...
        if (typeof events === 'string') {
            events = CLI.Array.clone(arguments);
        }
    ...
    deprecated: {
        '2.0': {
            methods: {
                 ...
                 * is destroyed.
                 * @param {CLI.mixin.Observable/HTMLElement} object The item to which to add a listener/listeners.
                ...
                addManagedListener: function() {
                    ...
                    observable.addListener.apply(observable, CLI.Array.slice(arguments, 1));
                },
                ...
                removeManagedListener: function() {
                    var observable = arguments[0];
                    observable.removeListener.apply(observable, CLI.Array.slice(arguments, 1));
                },

                /**
                 * @method
                 * Alias for {@link #addManagedListener}.
                 * @inheritdoc CLI.mixin.Observable#addManagedListener
                 ...
                 * @inheritdoc CLI.mixin.Observable#removeManagedListener
                 * @deprecated 2.0.0 This is now done automatically
                 */
                mun: function() {
                    var observable = arguments[0];
